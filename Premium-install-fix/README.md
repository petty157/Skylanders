...
3. Sets `minFreeSpaceGameFull` to your current free space + 1 GB
4. Writes the change safely using a temp file — original is untouched if anything fails

If the file is found in multiple locations (external SD card, secondary user profile, leftover install), it warns you and lets you choose which to patch or patch all at once.
